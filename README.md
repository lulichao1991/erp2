...
- `/finance` 提供财务中心，以 OrderLine 货号台账展示应收、收款、退款、净收、待收、补款 / 退款复核、退款原因补录与异常解除、商品行成本卡、旧金抵扣入库关联、FIFO 库存领用成本、工厂回传数据、结算确认、异常标记和锁定；财务确认或锁定后对应货号的收退款、结算金额、备注和异常处理进入只读；Purchase 只做聚合摘要
